...
module.exports = {
  ...
  rules: {
    ...
    'no-console': [1, { allow: ['warn', 'error'] }], // disallow use of console (off by default in the node environment)
     ...
     */
    'sort/destructuring-properties': [1, { caseSensitive: false, natural: true }],
    'sort/object-properties': [1, { caseSensitive: false, natural: true }],
    'sort/type-properties': [1, { caseSensitive: false, natural: true }],
    'sort/string-enums': [1, { caseSensitive: false, natural: true }],
    'sort/string-unions': [1, { caseSensitive: false, natural: true }],
